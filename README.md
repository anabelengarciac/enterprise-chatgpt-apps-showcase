...
```mermaid
flowchart LR
    A["Business user"] --> B["ChatGPT App"]
    B --> C["MCP connector layer"]
    C --> D["Enterprise APIs and data sources"]
    B --> E["Embedded UI widget"]
    E --> F["Structured feedback loop"]
    F --> G["Product and technical iteration"]
    G --> B
```
